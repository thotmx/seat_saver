...
var _user$project$SeatSaver$seatRequests = _elm_lang$core$Native_Platform.outgoingPort(
	'seatRequests',
	function (v) {
		return {seatNumber: v.seatNumber, occupied: v.occupied};
	});
		...
		switch (_p0.ctor) {
			case 'Toggle':
				...
				var updateSeat = function (seatFromModel) {
					return _elm_lang$core$Native_Utils.eq(seatFromModel.seatNumber, _p1.seatNumber) ? _elm_lang$core$Native_Utils.update(
						seatFromModel,
						{occupied: _p1.occupied}) : seatFromModel;
				};
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$SeatSaver$seatRequests(_p0._0)
				};
		}
	});
var _user$project$SeatSaver$seatUpdates = _elm_lang$core$Native_Platform.incomingPort(
	'seatUpdates',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (seatNumber) {
...
var _user$project$SeatSaver$ToggleSeat = function (a) {
	return {ctor: 'ToggleSeat', _0: a};
};
		...
		_elm_lang$html$Html$li,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$SeatSaver$ToggleSeat(seat)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _user$project$SeatSaver$updateSeat = function (seat) {
	return _user$project$SeatSaver$Toggle(seat);
};
var _user$project$SeatSaver$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$SeatSaver$seatLists(_user$project$SeatSaver$UpdateAll),
			_1: {
				ctor: '::',
				_0: _user$project$SeatSaver$seatUpdates(_user$project$SeatSaver$Toggle),
				_1: {ctor: '[]'}
			}
		});
};
...
if (typeof _user$project$SeatSaver$main !== 'undefined') {
    _user$project$SeatSaver$main(Elm['SeatSaver'], 'SeatSaver', {"types":{"unions":{"SeatSaver.Msg":{"args":[],"tags":{"Toggle":["SeatSaver.Seat"],"UpdateAll":["SeatSaver.Model"],"ToggleSeat":["SeatSaver.Seat"]}}},"aliases":{"SeatSaver.Seat":{"args":[],"type":"{ seatNumber : Int, occupied : Bool }"},"SeatSaver.Model":{"args":[],"type":"List SeatSaver.Seat"}},"message":"SeatSaver.Msg"},"versions":{"elm":"0.18.0"}});
}
