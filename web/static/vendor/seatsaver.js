...
if (typeof _user$project$SeatSaver$main !== 'undefined') {
    _user$project$SeatSaver$main(Elm['SeatSaver'], 'SeatSaver', {"types":{"unions":{"SeatSaver.Msg":{"args":[],"tags":{"Toggle":["SeatSaver.Seat"],"FetchedSeats":["Result.Result Http.Error SeatSaver.Model"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"SeatSaver.Seat":{"args":[],"type":"{ seatNumber : Int, occupied : Bool }"},"SeatSaver.Model":{"args":[],"type":"List SeatSaver.Seat"}},"message":"SeatSaver.Msg"},"versions":{"elm":"0.18.0"}});
}
